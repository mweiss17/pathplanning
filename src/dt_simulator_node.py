...
class SimNode(object):
    ...
    def __init__(self):        
        ...
        self.our_duckie_radius = rospy.get_param("/dt_simulator_node/our_duckie/radius")
        self.our_duckie_type = rospy.get_param("/dt_simulator_node/our_duckie/type")
        ...
        self.other_duckie_radius = rospy.get_param("/dt_simulator_node/other_duckie/radius")
        ...
        # Publishers
        self.pub_pose_our_duckie = rospy.Publisher("/sim/gt/pose_our_duckie",Pose2D, queue_size=1)
    ...
    def publish_obs(self):
        ...
        ourd_p, _, _, othd_p = self.world.get_state()
    ...
    def publish_state(self):
        ...
        ourd_p, ourd_ss, ourd_gt, othd_p = self.world.get_state()
        ...
        othd_p_msg.y = othd_p[1]
        othd_p_msg.theta = othd_p[2]
        self.pub_pose_our_duckie.publish(othd_p_msg)
